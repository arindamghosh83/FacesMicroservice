...
namespace FacesApi.Controllers
{
    ...
    public class FacesController : ControllerBase
    {
        ...
        private List<byte[]> GetFaces(byte[] image)
        {
            ...
            // Converts the byte array into jpeg image and save the image coming from the source
            ...
            foreach(var rect in faces)
            {
                ...
                faceList.Add(faceImage.ToBytes(".jpg")); //Encodes an image to a memory buffer
